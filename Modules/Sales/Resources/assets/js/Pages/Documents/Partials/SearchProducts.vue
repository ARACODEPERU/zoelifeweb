...
<template>
    ...
    <div v-show="displaySearch" style="min-width: 350px;max-width: 350px;" class="absolute z-99 mt-1 bg-white selector-d  border border-gray-400 shadow w-60 dark:bg-gray-700">
        <div class="p-4">
            ...
            <div class="grid grid-cols-3">
                <div class="col-span-1">
                    <div class="flex flex-wrap justify-center p-4">
                        ...
                        class="p-1 bg-white selector-d  border rounded max-w-sm"
