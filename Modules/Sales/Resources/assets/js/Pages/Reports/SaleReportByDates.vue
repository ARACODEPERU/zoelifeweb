                        ...
                        <div class="grid grid-cols-6 gap-3 py-2">
                            ...
                            <div class="col-span-6 sm:col-span-1">
                                <input type="date" v-model="form.start" v-on:change="getReport()"
                                    class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white selector-d  bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    id="f1" />
                            </div>
                            <div class="col-span-6 sm:col-span-1">
                            ...
                            <div v-if="false" class="col-span-6 sm:col-span-1">
                                <button v-on:click="downloadExcel()"
                                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white selector-d  bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none dark:bg-gray-700 "
                                        >Exportar en Excel
                                </button>
                            </div>
