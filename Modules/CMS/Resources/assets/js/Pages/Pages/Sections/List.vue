                ...
                <div class="rounded-sm border border-stroke bg-white selector-d  shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                    <div class="grid grid-cols-4">
                        <div class="col-span-4 md:col-span-1 p-4">
                            <div class="w-full text-sm font-medium text-gray-900 bg-white selector-d  border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
