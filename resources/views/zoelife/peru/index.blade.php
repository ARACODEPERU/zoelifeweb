...
<head>
	...
	<!-- STYLESHEETS -->
	<link rel="stylesheet" type="text/css" href="themes/zoelife/paises/css/plugins.css">
	<link rel="stylesheet" type="text/css" href="themes/zoelife/paises/css/style.css">
	<link rel="stylesheet" type="text/css" href="themes/zoelife/paises/css/templete.css">
	<link rel="stylesheet" type="text/css" class="skin" href="themes/zoelife/paises/css/skin/skin-9.css">
	
	<!-- REVOLUTION SLIDER CSS -->
	<link rel="stylesheet" type="text/css" href="themes/zoelife/paises/plugins/revolution/revolution/css/settings.css">
	<link rel="stylesheet" type="text/css" href="themes/zoelife/paises/plugins/revolution/revolution/css/navigation.css">
            ...
            <div class="main-bar clearfix ">
                <div class="container clearfix">
                    ...
                    <div class="logo-header logo-dark mostion">
						<a href="index.html"><img src="themes/zoelife/paises/images/garden/logo9.png" width="193" height="89" alt=""></a>
					</div>
                    <!-- Nav Toggle Button -->
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"> <a href="">Centros de Distribución</a> </li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="widget widget_about">
                            <div class="logo-footer"><img src="themes/zoelife/paises/images/garden/logo-white.png" alt=""></div>
                            <p class="m-tb20"><strong>CargoZone</strong> Lorem ipsum dolor sit amet, cons ectetur elit. Vestibulum nec odios Suspe ndisse cursus.  cons ectetur elit. Vestibulum nec odios Lorem ipsum dolor sit amet, cons ectetur elit. Vestibulum nec.</p>
                            <ul class="dez-social-icon dez-border dez-social-icon-lg">
                                <li><a href="javascript:void(0);" class="fa fa-facebook fb-btn"></a></li>
                                <li><a href="javascript:void(0);" class="fa fa-twitter tw-btn"></a></li>
                                <li><a href="javascript:void(0);" class="fa fa-linkedin link-btn"></a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="widget recent-posts-entry">
                            <h4 class="m-b10 text-uppercase">Recent Post</h4>
                            <div class="dez-separator bg-primary"></div>
                            <div class="widget-post-bx">
                                <div class="widget-post clearfix">
                                    <div class="dez-post-media"> <img src="themes/zoelife/paises/images/blog/recent-blog/pic1.jpg" alt="" width="200" height="143"> </div>
                                ...
                                <div class="widget-post clearfix">
                                    <div class="dez-post-media"> <img src="themes/zoelife/paises/images/blog/recent-blog/pic2.jpg" alt="" width="200" height="160"> </div>
                                    <div class="dez-post-info">
                                        <div class="dez-post-header">
                                            <h6 class="post-title"><a href="blog-single.html">Title of first blog</a></h6>
                                        </div>
                                ...
                                <div class="widget-post clearfix">
                                    <div class="dez-post-media"> <img src="themes/zoelife/paises/images/blog/recent-blog/pic3.jpg" alt="" width="200" height="160"> </div>
                                    <div class="dez-post-info">
                                        <div class="dez-post-header">
                                            <h6 class="post-title"><a href="blog-single.html">Title of first blog</a></h6>
                                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="widget widget_services">
                            ...
                            <div class="dez-separator bg-primary"></div>
                            <ul>
                                <li><a href="services-2.html">Residential Cargo</a></li>
                                <li><a href="services-2.html">Office Cargo</a></li>
                                <li><a href="services-2.html">Wall Painting</a></li>
                                <li><a href="services-2.html">Window Cargo</a></li>
                                <li><a href="services-2.html">Commercial Cargo</a></li>
                                <li><a href="services-2.html">Office Cargo</a></li>
                            </ul>
                        </div>
                    </div>
...
<!-- JavaScript files ========================================= -->
<script src="themes/zoelife/paises/js/jquery.min.js"></script><!-- JQUERY.MIN JS -->
<script src="themes/zoelife/paises/plugins/bootstrap/js/popper.min.js"></script><!-- BOOTSTRAP.MIN JS -->
<script src="themes/zoelife/paises/plugins/bootstrap/js/bootstrap.min.js"></script><!-- BOOTSTRAP.MIN JS -->
<script src="themes/zoelife/paises/plugins/bootstrap-select/bootstrap-select.min.js"></script><!-- FORM JS -->
<script src="themes/zoelife/paises/plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.js"></script><!-- FORM JS -->
<script src="themes/zoelife/paises/plugins/magnific-popup/magnific-popup.js"></script><!-- MAGNIFIC POPUP JS -->
<script src="themes/zoelife/paises/plugins/counter/waypoints-min.js"></script><!-- WAYPOINTS JS -->
<script src="themes/zoelife/paises/plugins/counter/counterup.min.js"></script><!-- COUNTERUP JS -->
<script src="themes/zoelife/paises/plugins/imagesloaded/imagesloaded.js"></script><!-- IMAGESLOADED -->
<script src="themes/zoelife/paises/plugins/masonry/masonry-3.1.4.js"></script><!-- MASONRY -->
<script src="themes/zoelife/paises/plugins/masonry/masonry.filter.js"></script><!-- MASONRY -->
<script src="themes/zoelife/paises/plugins/owl-carousel/owl.carousel.js"></script><!-- OWL SLIDER -->
<script src="themes/zoelife/paises/plugins/switcher/js/switcher.js"></script><!-- SWITCHER JS  -->
<script src="themes/zoelife/paises/js/custom.js"></script><!-- CUSTOM FUCTIONS  -->
<script src="themes/zoelife/paises/js/dz.carousel.js"></script><!-- SORTCODE FUCTIONS  -->
<script src="themes/zoelife/paises/js/dz.ajax.js"></script><!-- CONTACT JS  -->
<!-- REVOLUTION JS FILES -->
<script src="themes/zoelife/paises/plugins/revolution/revolution/js/jquery.themepunch.tools.min.js"></script>
<script src="themes/zoelife/paises/plugins/revolution/revolution/js/jquery.themepunch.revolution.min.js"></script>
<!-- Slider revolution 5.0 Extensions  (Load Extensions only on Local File Systems !  The following part can be removed on Server for On Demand Loading) -->
<script src="themes/zoelife/paises/plugins/revolution/revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script src="themes/zoelife/paises/plugins/revolution/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script src="themes/zoelife/paises/plugins/revolution/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script src="themes/zoelife/paises/plugins/revolution/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script src="themes/zoelife/paises/plugins/revolution/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script src="themes/zoelife/paises/plugins/revolution/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script src="themes/zoelife/paises/plugins/revolution/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script src="themes/zoelife/paises/plugins/revolution/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script src="themes/zoelife/paises/plugins/revolution/revolution/js/extensions/revolution.extension.video.min.js"></script>
<script src="themes/zoelife/paises/js/rev.slider.js"></script>
<script>
