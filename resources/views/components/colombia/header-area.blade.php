                ...
                <div class="top-bar-contect-space row justify-content-between">
                    <div class="dez-topbar-right list-unstyled e-p-bx ">
                        <ul>
                            ...
                            <li>
                                <i class="fa fa-phone"></i><span>(+57) {{ $header[4]->content }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="clearfix" style="width: 100%; padding: 0px 40px;">
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-end div-nav-slide-dark"
                        ...
                        <ul class="nav navbar-nav div-nav-slide-dark">
                            ...
                            @endphp
                            <li>
                                <a class="dropdown-item aquitoy {{ $currentUrl == route('web_colombia_productos', 1) ? 'active' : '' }}"
                                    href="{{ route('web_colombia_productos', 1) }}">Zoé nutraceúticos</a>
                                <ul class="sub-menu">
                                    @foreach ($productsct1 as $product)
                                        <li>
                                            <a href="{{ route('web_colombia_producto_descripcion', $product->id) }}">
                                                {{ $product->name }}
                                            </a>
                                        </li>
                                    @endforeach
                            ...
                            <li>
                                <a class="dropdown-item aquitoy {{ $currentUrl == route('web_colombia_productos', 2) ? 'active' : '' }}"
                                    href="{{ route('web_colombia_productos', 2) }}">Cuidado Personal</a>
                                <ul class="sub-menu">
                                    @foreach ($productsct2 as $product2)
                                        <li>
                                            <a href="{{ route('web_colombia_producto_descripcion', $product2->id) }}">
                                                {{ $product2->name }}
                                            </a>
                                        </li>
                                    @endforeach
                            ...
                            {{-- <li>
                                <a class="dropdown-item aquitoy {{ request()->routeIs('web_colombia_productos') ? 'active' : '' }}"
                                    href="{{ route('web_colombia_productos') }}">Productos
                                </a>
                                <ul class="sub-menu">
                            ...
                            <li> <a class="dropdown-item aquitoy {{ request()->routeIs('web_colombia_testimonios') ? 'active' : '' }}"
                                    href="{{ route('web_colombia_testimonios') }}">Testimonios</a> </li>
                            <li> <a class="dropdown-item aquitoy {{ request()->routeIs('web_colombia_centros') ? 'active' : '' }}"
                                    href="{{ route('web_colombia_centros') }}">Centros de Distribución</a> </li>
                            <li> <a class="dropdown-item aquitoy {{ request()->routeIs('web_colombia_eventos') ? 'active' : '' }}"
                                    href="{{ route('web_colombia_eventos') }}">Eventos</a> </li>
                            <li> <a class="dropdown-item aquitoy {{ request()->routeIs('web_colombia_alcanzando_las_estrellas') ? 'active' : '' }}"
                                    href="{{ route('web_colombia_alcanzando_las_estrellas') }}">Alcanzando las
                                    Estrellas</a> </li>

                            <li> <a class="dropdown-item aquitoy {{ request()->routeIs('web_colombia_university') ? 'active' : '' }}"
                                    href="{{ route('web_colombia_university') }}">University</a> </li>
                            <li> <a class="dropdown-item aquitoy {{ request()->routeIs('web_colombia_contacto') ? 'active' : '' }}"
                                    href="{{ route('web_colombia_contacto') }}">Contacto</a> </li>
