            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="project_box type_one">
                        <div class="image_box ">
                            <img src="{{ $group->item->items[0]->content }}" class="img-fluid"
                                alt="img" />
                            <div class="overlay">
                                Hola
                                <a data-fancybox="gallery" class="zm_btn"
                                    href="{{ $group->item->items[0]->content }}">
                        ...
                        <div class="content_box">
                            <div class="content_box_inner">
                                ...
                                <h2 class="entry-title">
                                    <a href="{{ $group->item->items[3]->content }}">
                                        {{ $group->item->items[1]->content }}
                                    </a>
                                </h2>
                                <p>
                                    <a href="{{ $group->item->items[3]->content }}">{{ $group->item->items[2]->content }}</a>
                                </p>
                                <a href="{{ $group->item->items[3]->content }}" target="_blank" class="read_more_link">
