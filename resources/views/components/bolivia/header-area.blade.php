                ...
                <div class="clearfix" style="width: 100%; padding: 0px 20px;">
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-end div-nav-slide-dark"
                        ...
                        <ul class="nav navbar-nav div-nav-slide-dark">
                            <li>
                                <a class="dropdown-item aquitoy {{ request()->routeIs('web_bolivia_inicio') ? 'active' : '' }}"
                                    href="{{ route('web_bolivia_inicio') }}">
                                    Inicio
                                </a>
                            </li>
                            {{-- <li>
                                <a class="dropdown-item aquitoy {{ request()->routeIs('web_bolivia_productos') ? 'active' : '' }}"
                                    href="{{ route('web_bolivia_productos') }}">
                                    Productos
                                </a>
                                <ul class="sub-menu">
                            ...
                            @endphp
                            <li>
                                <a class="dropdown-item aquitoy {{ $currentUrl == route('web_bolivia_productos', 1) ? 'active' : '' }}"
                                    href="{{ route('web_bolivia_productos', 1) }}">Zoé nutraceúticos</a>
                                <ul class="sub-menu">
                            ...
                            <li>
                                <a class="dropdown-item aquitoy {{ $currentUrl == route('web_bolivia_productos', 2) ? 'active' : '' }}"
                                    href="{{ route('web_bolivia_productos', 2) }}">Cuidado Personal</a>
                                <ul class="sub-menu">
                                    @foreach ($productsct2 as $product2)
                                        <li>
                                            <a href="{{ route('web_bolivia_producto_descripcion', $product2->id) }}">
                                                {{ $product2->name }}
                                            </a>
                                        </li>
                                    @endforeach
                            ...
                            <li>
                                <a class="dropdown-item aquitoy {{ request()->routeIs('web_bolivia_testimonios') ? 'active' : '' }}"
                                    href="{{ route('web_bolivia_testimonios') }}">
                                    Testimonios
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item aquitoy {{ request()->routeIs('web_bolivia_centros') ? 'active' : '' }}"
                                    href="{{ route('web_bolivia_centros') }}">
                                    Centros de Distribución
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item aquitoy {{ request()->routeIs('web_bolivia_eventos') ? 'active' : '' }}"
                                    href="{{ route('web_bolivia_eventos') }}">
                            ...
                            <li>
                                <a class="dropdown-item aquitoy {{ request()->routeIs('web_bolivia_contacto') ? 'active' : '' }}"
                                    href="{{ route('web_bolivia_contacto') }}">
                                    Contacto
                                </a>
                            </li>
