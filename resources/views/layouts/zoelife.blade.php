...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/zoelife/global/css/all.min.css') }}" /> 
    <link rel="stylesheet" href="{{ asset('themes/zoelife/global/css/fontawesome.min.css') }}" /> 
    <link rel="stylesheet" href="{{ asset('themes/zoelife/global/css/ionicons.min.css') }}" /> 
    <link rel="stylesheet" href="{{ asset('themes/zoelife/global/css/slick.min.css') }}" /> 
    <link rel="stylesheet" href="{{ asset('themes/zoelife/global/css/owl.carousel.min.css') }}" /> 
    <link rel="stylesheet" href="{{ asset('themes/zoelife/global/css/magnific-popup.min.css') }}" /> 
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="#">
                                <img class="img-fluid logo" src="{{ asset('themes/zoelife/global/images/logo-1.png') }}" alt="streamlab-image">
                            </a>
                ...
                <div class="col-12">
                    <div class="gen-banner-movies">
                        <div class="owl-carousel " 
                            ...
                            <div class="item" style="background: url('{{ asset('themes/zoelife/global/images/background/asset-53.jpg') }}')">
                            ...
                            <div class="item" style="background: url('images/background/asset-61.jpg')">
                                <div class="gen-movie-contain h-100">
                                    <div class="container h-100">
                                        <div class="row align-items-center h-100">
                                            <div class="col-xl-6">
